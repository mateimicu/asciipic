...
class AsciipicJournalizeOptions(conf_base.Options):
    ...
    def __init__(self, config):
        super(AsciipicJournalizeOptions, self).__init__(config, group="journalize")
        self._options = [
            cfg.StrOpt(
                "journalize_host", default="https://journalize.asciipic.xyz/",
    ...
    def register(self):
        ...
        group = cfg.OptGroup(self.group_name, title='Asciipic journalize Options')
